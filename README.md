...
5. Использовать другие операции над циклом (к примеру, циклический сдвиг подотрезка);
